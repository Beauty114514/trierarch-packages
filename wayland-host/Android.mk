...
LOCAL_SRC_FILES := src/compositor.c src/gpu_probe.c src/adreno_presenter.c src/output.c src/seat.c src/keycode_map.c src/pointer_constraints.c src/presentation.c src/buffer_shm.c src/linux_dmabuf.c src/egl_buffer.c src/renderer.c src/single_pixel_buffer.c src/viewporter.c src/surface.c src/subcompositor.c src/xdg_shell.c src/xdg_output.c src/xdg_decoration.c src/protocol_stubs.c src/jni_bridge.c $(PROTO_DIR)/xdg-shell-protocol.c $(PROTO_DIR)/linux-dmabuf-v1-protocol.c $(PROTO_DIR)/single-pixel-buffer-v1-protocol.c $(PROTO_DIR)/viewporter-protocol.c $(PROTO_DIR)/pointer-constraints-protocol.c $(PROTO_DIR)/presentation-time-protocol.c $(PROTO_DIR)/xdg-output-unstable-v1-protocol.c $(PROTO_DIR)/xdg-decoration-unstable-v1-protocol.c $(PROTO_DIR)/fractional-scale-v1-protocol.c $(PROTO_DIR)/relative-pointer-unstable-v1-protocol.c $(PROTO_DIR)/android-wlegl-protocol.c $(PROTO_DIR)/trierarch-adreno-presenter-v1-protocol.c
